    ...
    : QAbstractTableModel(parent)
{
    ...
    _header.append("Name");
    _header.append("Platform");
    _header.append("Year");
    _header.append("Genre");
    _header.append("Publisher");
    _header.append("Global_Sales");
...
void ExampleModel::addRow(QList<QVariant> row)
{
    int nRows = rowCount();
